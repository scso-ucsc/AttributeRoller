const defaultAttributeScores = [15, 14, 13, 12, 10, 8]; //Array is constant and will never change value
...
class Player{
    ...
    rollAttributes(){
        for(const key in this.attributes){
            ...
            let sum = sumArrayElements(results); //sums total
...
function shuffleArray(targetArray){
    let shuffled = Array.from(targetArray); //Making a clone of targetArray in order to mutate
